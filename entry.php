<div class="post hentry" id="post-<?php the_ID(); ?>">
  ...
  <p class="social-services">
   ...
   <iframe src="http://www.facebook.com/plugins/like.php?href=<?php the_permalink() ?>&layout=standard&show_faces=false&width=400&action=like&colorscheme=light" allowtransparency="true" style="border: medium none; overflow: hidden; width: 400px; height: 24px;" frameborder="0" scrolling="no"></iframe>
  </p>
